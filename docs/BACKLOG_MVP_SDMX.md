...
### 4.6 Shops y suscripciones

Prioridad: `P0`

Objetivo:

- dejar resuelto el modelo SaaS comercial desde el día uno
...
- validación backend de acceso por shop
- precio base mensual configurado en `350 MXN`

...
cat > ./src/components/hub/CustomersPanel.tsx <<'TSX'
"use client";
...
cat > ./src/components/hub/ArchivePanel.tsx <<'TSX'
"use client";
...
if 'import CustomersPanel from "../../../components/hub/CustomersPanel";' not in text:
    text = text.replace(
...
sed -n '1,160p' "./src/app/(dashboard)/hub/page.tsx"
echo

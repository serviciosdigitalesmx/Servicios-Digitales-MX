...
function PortalContent() {
  ...
  const [shop, setShop] = useState<{name: string, id: string, slug?: string} | null>(null);
      ...
      <main className="max-w-4xl mx-auto p-6 py-20 text-center">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <button
            ...
            className="mt-8 w-full md:w-auto md:absolute md:right-3 md:top-3 md:mt-0 bg-blue-600 hover:bg-blue-500 px-10 py-4 rounded-2xl font-black uppercase text-sm tracking-widest transition-all inline-flex items-center justify-center gap-2"
          >
            <Search size={16} />
            Consultar Estatus
          </button>
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                  <div>
                    ...
                    <p className="text-slate-400 mt-2 max-w-2xl">
                      {shop?.name || "Tu taller"} está trabajando en tu equipo. Aquí puedes ver el avance más reciente y la fecha estimada de entrega.
                    </p>
                  </div>

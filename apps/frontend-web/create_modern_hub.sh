...
mkdir -p "$BASE/src/components/hub"
mkdir -p "$BASE/src/app/hub"

cat > "$BASE/src/components/hub/Sidebar.tsx" <<'TSX'
"use client";
...
cat > "$BASE/src/components/hub/Dashboard.tsx" <<'TSX'
"use client";
...
cat > "$BASE/src/app/hub/page.tsx" <<'TSX'
"use client";
...
find src/components/hub src/app/hub -type f | sort
echo
npm run dev
